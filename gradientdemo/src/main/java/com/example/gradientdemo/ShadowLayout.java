...
public class ShadowLayout extends RelativeLayout {
    ...
    //阴影最大偏移量
    public static final float SHADOW_MAX_OFFSET = dp2px(20);

    //阴影最大模糊半径
    public static final float SHADOW_MAX_BLUR = dp2px(24);


    //默认模糊半径
    public static final float SHADOW_DEFAULT_BLUR_RADIUS = dp2px(24);


    //阴影颜色
    private int shadowColor = Color.parseColor("#801A1A38");
    ...
    //水平位移
    private float xOffset = dp2px(0);


    //竖直方向位移
    private float yOffset = dp2px(0);
    ...
    public ShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        shadowColor = typedArray.getColor(R.styleable.ShadowLayout_shadowColor, Color.parseColor("#801A1A38"));
        ...
        xOffset = typedArray.getDimension(R.styleable.ShadowLayout_xOffset, dp2px(0));
        yOffset = typedArray.getDimension(R.styleable.ShadowLayout_yOffset, dp2px(0));
